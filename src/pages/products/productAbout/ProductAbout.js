...
const ProductAbout = React.memo(function () {
    return (
        <section className="product-about">
            <div className="container">
                <div className="product-about__wrapper">
                    <img src={girlImg} alt="" className="product-about__img" />

                    <div className="product-about__content">
                        <h3 className="product-about__title">About our beans</h3>
                        <div className="beans-icon product-about__beans">
                        ...
                        <p className="product-about__text">Extremity sweetness difficult behaviour he of. On disposal of as landlord horrible.
                            <br /> <br />
                            Afraid at highly months do things on at. Situation recommend objection do intention so questions.
                            <br />
                            As greatly removed calling pleased improve an. Last ask him cold feel  met spot shy want. Children me laughing we prospect answered followed. At it went is song that held help face.</p>
                    </div>
                </div>
                <div className="product-about__divider"></div>
            </div>
        </section>
    )
})
